#!/bin/bash 
valgrind ./build/bin/task2 -d ./data/binary/train_labels.txt -m ./model.txt --train
valgrind ./build/bin/task2 -d ./data/binary/test_labels.txt -m ./model.txt -l ./predictions.txt --predict
